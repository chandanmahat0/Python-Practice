...
5
Explanation 0
Given list is [2, 3, 6, 6, 5]. The maximum score is 6, and the second maximum is 5. Hence, we print 5 as the runner-up score.

"""
# Read number of scores
n = int(input())

# Read scores and convert to list of ints
arr = list(map(int, input().split()))  

# Convert to set to remove duplicates, then back to sorted list
unique_scores = sorted(set(arr))

# Runner-up will be the second last element in sorted unique list
